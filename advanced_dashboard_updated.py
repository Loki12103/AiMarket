...
# Import streamlit_scheduler to start background automation
# This runs weekly data collection, sentiment monitoring, and sends alerts
import streamlit_scheduler
# ---------------------------------------------------
